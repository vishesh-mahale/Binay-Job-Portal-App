...
| `Requirement/old_NESTJS-GUIDE.md` | SERVICE CONTRACT INPUT + HISTORICAL CONFLICTS | Useful responsibilities/examples current architecture के अनुसार rewrite करके `04-nestjs-api/NESTJS-IMPLEMENTATION-GUIDE.md` में migrated; obsolete mechanisms को corrected-decision list में trace किया गया |
