...
export class FeedbackService {
  ...
  async submit(userId: string, dto: { category?: string; subject?: string; message?: string; rating?: number }) {
...
export class FeedbackController {
  ...
  @Post()
  submit(@Req() req: AuthRequest, @Body() dto: { category?: string; subject?: string; message?: string; rating?: number }) {
