...
export class AddCompanyMemberDto { user_id!: string; branch_id?: string; department_id?: string; team_id?: string; manager_member_id?: string; title?: string; employee_code?: string; is_primary_hr?: boolean; permissions?: Record<string, unknown>; employment_type?: string; work_email?: string; work_phone?: string; }
