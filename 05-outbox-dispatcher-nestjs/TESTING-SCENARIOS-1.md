...
| **B-05** | **Google Cloud Scheduler Recovery Provisioning** | GCP Cloud Scheduler + Supabase function | Verify `dev-outbox-recovery-sweep` runs every 10 minutes and calls the public wake endpoint; separately verify `SELECT public.outbox_recovery_needed()` is callable. | [`LOCAL-TESTING-OPTIONS.md`](file:///C:/Users/ADMIN/OneDrive/Desktop/Vishesh/Binay-Job-Portal-App/05-outbox-dispatcher-nestjs/LOCAL-TESTING-OPTIONS.md) |
