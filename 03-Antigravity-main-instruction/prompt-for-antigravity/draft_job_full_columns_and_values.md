...
**Status:** `draft`
**Audit Time:** `2026-09-06T05:58:02.762Z`
...
| `public.companies` | Foreign Key (`company_id`) | Company: "Acme Tech Solutions" | ✅ Linked |
...
|---|---|---|---|---|
| **Created By (Job Poster)** | `80d8e17b-8682-4e52-ac3d-4ff3047e4590` | Synthetic Employer | employer.test@example.com | `employer` |
